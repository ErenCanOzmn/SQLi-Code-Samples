...
class Database {
    ...
    public function searchCarBrands($brand) {
        $sql = "SELECT brand, model FROM car_brands WHERE 1=1";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['search'])) {
    ...
    list($sql, $cars, $error) = $db->searchCarBrands($brand);
} else {
    $error = '';
}
?>
...
<html>
<head>
    <title>Araba Markası Sorgulama Formu</title>
    <style>
        body {
...
<body>
    <h2>Araba Markası Sorgulama Formu</h2>
